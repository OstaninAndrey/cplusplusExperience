...
public class Validate {
    public static final int MAX_LEN = 1_00_000;
    ...
    public void run() {
        ...
        ensureLimits(n, 1, MAX_LEN, "N doesn't satisfy to restrictions");
        ensureLimits(m, 1, MAX_LEN, "M doesn't satisfy to restrictions");
        ensureLimits(p, 1, MAX_LEN, "P doesn't satisfy to restrictions");
